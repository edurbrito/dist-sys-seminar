...
making these protocols unsuitable for resource-constrained applications. Other concerns are the
security issues, as some attempts to overcome the resource constraints may lead to new vulnerabilities,
...
However, there are still known security and centralization limitations, as presented in the sections before.
...
However, this does not address the hipothesis of taking advantage of the very nature of these limited environments, 
...
either by proximity, or by some other withnessing mechanism. Variations and 
