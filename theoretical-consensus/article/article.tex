...
\begin{abstract}
Disclaimer: This paper is a work in progress. It is not a final version and it is not intended to be submited yet to the Distributed Systems Seminar. The content of this paper is subject to change.
\end{abstract}
...
\emph{txDAG}. The block-based DAG approach diverges from the traditional blockchain structure by flexibly 
